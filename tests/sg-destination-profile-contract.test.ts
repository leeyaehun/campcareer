...
const foundation = read("supabase/migrations/20260810111442_sg_destination_foundation_v1.sql")
const linkage = read("supabase/migrations/20260810111702_sg_destination_linkage_v1.sql")
const metrics = read("supabase/migrations/20260810111850_sg_destination_metrics_v1.sql")
