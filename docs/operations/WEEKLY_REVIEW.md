...
Owner:  
Release/data version reviewed:

| Area | Observation | Evidence source | Action / owner / due date |
| --- | --- | --- | --- |
...
| Cross-entity navigation | | GA4 | |
| Errors and critical route failures | | Vercel logs / CI | |
