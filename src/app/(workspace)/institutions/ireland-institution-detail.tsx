...
import { ArrowUpRight, Building2, ExternalLink, MapPin, ShieldCheck } from "lucide-react"
...
export function IrelandInstitutionDetailView({ institution }: { institution: IrelandInstitution }) {
